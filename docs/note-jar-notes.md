...
342 notes in 19 groups. Edit, add or delete lines (one note per "- " line), then paste back.

## art — ur art deserves some love
...
## cosplay — a little cosplay appreciation
...
## fandom — for ur very specific interests
...
## kindness — this is something i like about u
...
## humour — affection, with commentary
_avoid: sad, anxious, overwhelmed, angry · min energy: 2_
...
## rest — a tiny reminder, because i care
...
## tough — a little love, a little nudge
_feelings: happy, excited, content, playful · min energy: 2_
...
## anxious — no pressure from this little note
_feelings: anxious_
...
## overwhelmed — one quiet bit of care
_feelings: overwhelmed_
...
## angry — on ur side, with some sense
_feelings: angry_
...
## excited — okay, tell me everything
_feelings: excited_
...
## content — a nice little moment for u
_feelings: content_
...
## playful — u can handle a little sass
_feelings: playful · min energy: 2_
...
## maomao — from the apothecary, apparently
_voice: maomao_
